...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 521: (e) => {
      ...
      r.r(i), r.d(i, { config: () => e5, middleware: () => e6 });
      let a = null;
      async function s() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      class k {
        ...
        set locale(e10) {
          var t2, r2;
          if (!this[M].locale || !(null == (r2 = this[M].options.nextConfig) ? void 0 : null == (t2 = r2.i18n) ? void 0 : t2.locales.includes(e10))) throw TypeError(`The NextURL configuration includes no locale "${e10}"`);
          this[M].locale = e10;
        }
        get defaultLocale() {
      ...
      function eq(e10, t2) {
        if ("x-middleware-set-cookie" in e10.headers && "string" == typeof e10.headers["x-middleware-set-cookie"]) {
          ...
          for (let e11 of new A.ResponseCookies(n2).getAll()) t2.set(e11);
        }
      }
      ...
      class eX {
        ...
        async runCallbacks() {
          ...
          let e10 = J.getStore();
          if (!e10) throw new eB("Missing workStore in AfterContext.runCallbacks");
      ...
      async function e4(e10) {
                ...
                let h3 = eY(), f3 = (u3 = p2.nextUrl, c2 = void 0, d3 = (e11) => {
                  ...
                  return { type: "request", phase: e11, implicitTags: i3 ?? [], url: { pathname: n4.pathname, search: n4.search ?? "" }, get headers() {
                    return d4.headers || (d4.headers = function(e12) {
                      let t5 = K.from(e12);
                      for (let e13 of H) t5.delete(e13.toLowerCase());
                      return K.seal(t5);
        ...
        if (m2) {
          for (let [e11, t3] of d2) b2.headers.set(`x-middleware-request-${e11}`, t3), w2.push(e11);
      ...
      function e6(e10) {
        let { pathname: t2 } = e10.nextUrl, r2 = e10.cookies.get("token");
        return t2.startsWith("/admin") && !r2 ? B.redirect(new URL("/login", e10.url)) : B.next();
      }
      RegExp(`\\n\\s+at __next_metadata_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_viewport_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_outlet_boundary__[\\n\\s]`);
      let e5 = { matcher: ["/admin/:path*"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let e9 = { ...i }, e7 = e9.middleware || e9.default, e8 = "/middleware";
      if ("function" != typeof e7) throw Error(`The Middleware "${e8}" must export a \`middleware\` or a \`default\` function`);
      function te(e10) {
        return e4({ ...e10, page: e8, handler: async (...e11) => {
          try {
            return await e7(...e11);
          } catch (i2) {
